      ...
      <div>
        ...
        >
          ...
          <div
            ...
            className="group relative flex items-center justify-center hover:bg-gray-500/20 transition-colors duration-300 h-9 w-9 aspect-square rounded-lg cursor-pointer"
          >
            <Image
      ...
      <div>
        ...
        <div
          ...
          className={`flex items-center ${
            expand ? "hover:bg-wihte/10 rounded-lg" : "justify-center w-full"
